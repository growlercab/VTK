...
#ifndef vtkDlangAwt_h
#define vtkDlangAwt_h

// for use with JAWT
#include "jawt_md.h"

#define VTK_DLANG_DEBUG
...
Dlang_vtk_vtkPanel_RenderCreate(JNIEnv *env, jobject canvas, jobject id0)
{
#if defined(WIN32_JAWT_LOCK_HACK)
  int hash;
  ...
  temp0 = (vtkRenderWindow *)(vtkDlangGetPointerFromObject(env,id0));

  /* Get the AWT */
  awt.version = JAWT_VERSION_1_3;
  if (JAWT_GetAWT(env, &awt) == JNI_FALSE)
  {
#ifndef VTK_DLANG_DEBUG
...
extern "C" JNIEXPORT jint  JNICALL
Dlang_vtk_rendering_awt_vtkInternalAwtComponent_RenderCreate(JNIEnv *env, jobject canvas, jobject id0)
{
#if defined(WIN32_JAWT_LOCK_HACK)
  int hash;
  WJLH_HASH_FUNC(env, canvas, hash);
...
// dlang threads are prevented from accessing X at the same time.  The only
...
extern "C" JNIEXPORT jint  JNICALL
Dlang_vtk_vtkPanel_Lock(JNIEnv *env,
                       jobject canvas)
{
  JAWT awt;
  JAWT_DrawingSurface* ds;
...
extern "C" JNIEXPORT jint  JNICALL
Dlang_vtk_vtkPanel_UnLock(JNIEnv *env,
                         jobject canvas)
{
  JAWT awt;
  JAWT_DrawingSurface* ds;
...
#endif
// VTK-HeaderTest-Exclude: vtkDlangAwt.h
